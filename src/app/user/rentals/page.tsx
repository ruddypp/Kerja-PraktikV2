    ...
    <DashboardLayout>
      ...
      {showReturnModal && selectedRental && (
        <div className="fixed inset-0 overflow-y-auto z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-lg max-w-lg w-full p-5 shadow-xl">
            <h2 className="text-lg font-medium text-gray-800 mb-4">Pengajuan Pengembalian Barang</h2>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <span className="text-sm font-medium text-gray-600">Tanggal Pinjam:</span>
              ...
              {selectedRental.statusLogs && selectedRental.statusLogs.length > 0 && selectedRental.statusLogs.some(log => log.notes) && (
                <div className="mb-4">
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <h4 className="text-sm font-medium text-blue-800 mb-2">Catatan Admin:</h4>
                    <div className="space-y-2">
                      {selectedRental.statusLogs
                        .filter(log => log.notes)
                        .map((log, index) => (
                          <div key={index} className="p-3 bg-white rounded-md border border-blue-100 text-sm text-gray-800">
                            <p className="text-xs text-gray-500 mb-1">
                              {new Date(log.createdAt).toLocaleString('id-ID')} - {log.changedBy.name}:
                            </p>
      ...
      {showDetailModal && detailRental && (
        <div className="fixed inset-0 overflow-y-auto z-50 flex items-center justify-center">
          <div className="fixed inset-0 backdrop-blur-sm"></div>
          <div className="relative bg-white rounded-lg max-w-xl w-full p-5 shadow-xl max-h-[80vh] overflow-y-auto">
            <button 
            ...
            <h2 className="text-lg font-medium text-gray-800 mb-4">Detail Rental</h2>
