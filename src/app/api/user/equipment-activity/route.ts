...
export async function GET(request: Request) {
  try {
    ...
    // Get rentals data for the year - filter by current user
    ...
    // Get calibrations data for the year - filter by current user
    ...
    // Get maintenance data for the year - filter by current user
