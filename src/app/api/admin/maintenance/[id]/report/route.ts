...
export async function GET(
  ...
  try {
    ...
    console.log(`Admin requesting ${reportType} report for maintenance ID:`, maintenanceId);
    ...
    console.log('Forwarding request to user maintenance report endpoint with admin access');
