...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      console.error('Database error fetching notification:', dbError);
      return NextResponse.json(
        { success: false, message: 'Database error fetching notification' },
        { status: 500 }
      );
    }
  } catch (error) {
...
export async function DELETE(
  ...
  try {
    ...
    try {
      ...
      return NextResponse.json(
        { success: false, message: 'Database error deleting notification' },
        { status: 500 }
      );
    }
  } catch (error) {
