    ...
    <DashboardLayout>
      ...
      {detailModalOpen && selectedRental && (
        <div className="fixed inset-0 overflow-y-auto z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-lg max-w-xl w-full max-h-[80vh] overflow-y-auto p-5 shadow-xl">
            <button 
            ...
            <div className="mt-6 pt-4 border-t border-gray-200">
              ...
              {/* Action form */}
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                {selectedRental.status === RequestStatus.PENDING && !isReturnRequested(selectedRental) && (
                ...
                {/* Update Status - Hide when it's a return verification */}
                {!isReturnRequested(selectedRental) && (
                  <>
                    <div className="mb-4">
