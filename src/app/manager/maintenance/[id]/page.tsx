...
export default function ManagerMaintenanceDetailPage() {
  ...
  const fetchMaintenanceDetails = useCallback(async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/manager/maintenance/${maintenanceId}`);
      ...
      <div className="space-y-6">
        ...
        {isPending ? (
          <MaintenanceForm 
            ...
            apiPath={`/api/manager/maintenance/${maintenance.id}/complete`}
          />
        ) : (
          <div className="bg-white rounded-lg border border-gray-100 p-6">
            ...
            {maintenance.serviceReport && (
              <div className="mb-6">
                ...
                <a
                  href={`/api/manager/maintenance/${maintenance.id}/report?type=csr`}
                  target="_blank"
            ...
            {maintenance.technicalReport && (
              <div>
                ...
                <a
                  href={`/api/manager/maintenance/${maintenance.id}/report?type=technical`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center text-green-600 hover:text-green-800"
                >
