  ...
  return (
    ...
    <li>
      <Link 
        ...
        className={`flex items-center p-3 rounded-lg transition-colors ${isActive('/manager-dashboard') ? 'bg-green-600 text-white font-medium' : 'text-gray-900 hover:bg-green-50 hover:text-green-600'}`}
        onClick={handleNavigation}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive('/manager-dashboard') ? 'text-white' : 'text-gray-500'} mr-3`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
        </svg>
        {(isOpen || isMobile) && 'Dashboard'}
      </Link>
    ...
    <li>
      <button 
        onClick={toggleInventory}
        className={`flex items-center justify-between w-full p-3 rounded-lg transition-colors ${
          isActive('/manager/inventory') || isActive('/manager/inventory/schedules')
            ? 'bg-green-600 text-white font-medium' 
            : 'text-gray-900 hover:bg-green-50 hover:text-green-600'
        }`}
      >
        <div className="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive('/manager/inventory') || isActive('/manager/inventory/schedules') ? 'text-white' : 'text-gray-500'} mr-3`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
          </svg>
          {(isOpen || isMobile) && 'Inventaris'}
        </div>
        {(isOpen || isMobile) && (
          <svg 
            className={`transition-transform transform ${inventoryOpen ? 'rotate-180' : ''} ${isActive('/manager/inventory') || isActive('/manager/inventory/schedules') ? 'text-white' : 'text-gray-500'}`}
            xmlns="http://www.w3.org/2000/svg" 
            width="16" 
            height="16" 
            viewBox="0 0 24 24" 
        ...
        <ul className="mt-1 pl-8 space-y-1">
          <li>
            <Link 
              ...
              className={`flex items-center p-2 rounded-md transition-colors ${isActive('/manager/inventory') && !isActive('/manager/inventory/schedules') ? 'text-green-600 font-medium' : 'text-gray-700 hover:text-green-600'}`}
              onClick={handleNavigation}
            >
              <span className={`w-2 h-2 ${isActive('/manager/inventory') && !isActive('/manager/inventory/schedules') ? 'bg-green-600' : 'bg-gray-400'} rounded-full mr-2`}></span>
              Items
            </Link>
          </li>
          <li>
            <Link 
              href="/manager/inventory/schedules" 
              className={`flex items-center p-2 rounded-md transition-colors ${isActive('/manager/inventory/schedules') ? 'text-green-600 font-medium' : 'text-gray-700 hover:text-green-600'}`}
              onClick={handleNavigation}
            >
              <span className={`w-2 h-2 ${isActive('/manager/inventory/schedules') ? 'bg-green-600' : 'bg-gray-400'} rounded-full mr-2`}></span>
              Schedules
            </Link>
          </li>
        </ul>
    ...
    <li>
      <Link 
        href="/manager/calibrations" 
        className={`flex items-center p-3 rounded-lg transition-colors ${isActive('/manager/calibrations') ? 'bg-green-600 text-white font-medium' : 'text-gray-900 hover:bg-green-50 hover:text-green-600'}`}
        onClick={handleNavigation}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive('/manager/calibrations') ? 'text-white' : 'text-gray-500'} mr-3`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
        </svg>
        {(isOpen || isMobile) && 'Kalibrasi'}
    ...
    <li>
      <Link 
        ...
        className={`flex items-center p-3 rounded-lg transition-colors ${isActive('/manager/rentals') ? 'bg-green-600 text-white font-medium' : 'text-gray-900 hover:bg-green-50 hover:text-green-600'}`}
        onClick={handleNavigation}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive('/manager/rentals') ? 'text-white' : 'text-gray-500'} mr-3`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
        {(isOpen || isMobile) && 'Rental'}
      </Link>
    ...
    <li>
      <Link 
        ...
        className={`flex items-center p-3 rounded-lg transition-colors ${isActive('/manager/vendors') ? 'bg-green-600 text-white font-medium' : 'text-gray-900 hover:bg-green-50 hover:text-green-600'}`}
        onClick={handleNavigation}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive('/manager/vendors') ? 'text-white' : 'text-gray-500'} mr-3`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
        </svg>
    ...
    <li>
      <Link 
        href="/manager/users" 
        className={`flex items-center p-3 rounded-lg transition-colors ${isActive('/manager/users') ? 'bg-green-600 text-white font-medium' : 'text-gray-900 hover:bg-green-50 hover:text-green-600'}`}
        onClick={handleNavigation}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive('/manager/users') ? 'text-white' : 'text-gray-500'} mr-3`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
        </svg>
        {(isOpen || isMobile) && 'Pengguna'}
      </Link>
    ...
    <li>
      <Link 
        ...
        className={`flex items-center p-3 rounded-lg transition-colors ${isActive('/manager/maintenance') ? 'bg-green-600 text-white font-medium' : 'text-gray-900 hover:bg-green-50 hover:text-green-600'}`}
        onClick={handleNavigation}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive('/manager/maintenance') ? 'text-white' : 'text-gray-500'} mr-3`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
        </svg>
        {(isOpen || isMobile) && 'Maintenance'}
      </Link>
    ...
    <li>
      <Link 
        ...
        className={`flex items-center p-3 rounded-lg transition-colors ${isActive('/manager/history') ? 'bg-green-600 text-white font-medium' : 'text-gray-900 hover:bg-green-50 hover:text-green-600'}`}
        onClick={handleNavigation}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive('/manager/history') ? 'text-white' : 'text-gray-500'} mr-3`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
        {(isOpen || isMobile) && 'History'}
      </Link>
          ...
          <li>
            <Link 
              ...
              className={`flex items-center p-3 rounded-lg transition-colors ${isActive(isAdmin ? '/admin/notifications' : '/notifications') ? 'bg-green-600 text-white font-medium' : 'text-gray-900 hover:bg-green-50 hover:text-green-600'}`}
              onClick={handleNavigation}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive(isAdmin ? '/admin/notifications' : '/notifications') ? 'text-white' : 'text-gray-500'} mr-3`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
